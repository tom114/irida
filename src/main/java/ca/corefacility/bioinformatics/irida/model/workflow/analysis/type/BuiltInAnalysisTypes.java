...
public class BuiltInAnalysisTypes {
	...
	public static final AnalysisType PHYLOGENOMICS = new AnalysisType("PHYLOGENOMICS", "tree");

	public static final AnalysisType SISTR_TYPING = new AnalysisType("SISTR_TYPING", "sistr");

	public static final AnalysisType ASSEMBLY_ANNOTATION = new AnalysisType("ASSEMBLY_ANNOTATION");

	public static final AnalysisType BIO_HANSEL = new AnalysisType("BIO_HANSEL", "hansel");
	...
	public static final AnalysisType MLST_MENTALIST = new AnalysisType("MLST_MENTALIST", "tree");
